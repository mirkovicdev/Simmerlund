        ...
        <div className="relative z-[1] flex flex-col items-center text-center">
          <div className="w-full flex flex-col items-center text-center sm:mb-16 mb-6">
            <h2 className="heading2">
              <span className="text-gradient">Resultater</span> som taler{" "}
              <br className="block sm:hidden" /> for seg selv
            </h2>
            <div className="w-full md:mt-6 mt-4 justify-center items-center mx-5">
              <p className="paragraph mx-auto max-w-[450px]">
                Oppdag hvordan jeg har hjulpet andre med å nå sine mål- La deres
                suksesshistorier inspirere deg på din egen reise.
              </p>
            </div>
          </div>
